...
def charts_core(pages, filtered_df):

        if pages == "production_charts":
            production_charts(filtered_df)
        elif pages == "finance_charts":
            finance_charts(filtered_df)
        elif pages == "actors_charts":
            actors_charts(filtered_df)
        elif pages == "genres_charts":
